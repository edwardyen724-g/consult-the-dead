    ...
    >
      ...
      <div className="relative overflow-hidden">
        ...
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at 20% 40%, ${framework.accent_color}10 0%, transparent 60%)`,
          }}
        />

        <div className="max-w-5xl mx-auto px-6 pt-8 pb-20 md:pt-12 md:pb-28 relative z-10">
          {/* Breadcrumb */}
          <nav className="mb-12">
            <Link
              href="/"
          ...
          {/* Framework identity — large and bold */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.h1
            ...
            className="font-serif text-4xl md:text-5xl lg:text-6xl font-light text-ink mb-3"
          >
          ...
          <motion.p
            ...
            className="text-lg text-muted mb-10 italic font-serif"
          >
      ...
      <div className="max-w-5xl mx-auto px-6">
        {/* Perceptual Lens — Spotlight/Shadow */}
        <ScrollReveal>
          <section className="mb-24 -mt-4">
            <div className="flex items-center gap-4 mb-8">
              <span className="w-2 h-2 rounded-full construct-node-pulse" style={{ backgroundColor: framework.accent_color }} />
            ...
            <motion.blockquote
              ...
              className="mb-10 pl-6 font-serif text-xl md:text-2xl leading-[1.6] text-ink italic"
              style={{ borderLeft: `2px solid ${framework.accent_color}` }}
            >
              &ldquo;{framework.perceptual_lens.statement}&rdquo;
            </motion.blockquote>
              ...
              <div className="relative p-8 md:p-10 bg-surface">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-xs font-semibold uppercase tracking-[0.15em]" style={{ color: framework.accent_color }}>
                      In sharp focus
                    </h3>
                  </div>
        ...
        <ScrollReveal>
          <section className="mb-24">
            <div className="flex items-center gap-4 mb-8">
              <span className="w-2 h-2 rounded-full" style={{ backgroundColor: framework.accent_color }} />
              <h2 className="font-sans text-[11px] font-semibold uppercase tracking-[0.2em] text-muted">
                Core Constructs
              </h2>
              <div className="flex-1 hr-crafted" />
                ...
                {articles.map((article) => (
                  ...
                  >
                    <Link
                      ...
                      className="group flex items-stretch gap-0 rounded-lg overflow-hidden border border-border
                    ...
                    >
                      {/* Accent bar */}
                      <div
                        className="w-1 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                        style={{ backgroundColor: framework.accent_color }}
                      />
                      <div className="flex-1 p-6 md:p-8 bg-surface group-hover:bg-surface/80 transition-colors duration-300">
