...
export const metadata: Metadata = {
  ...
  description:
    "42 high-intent decisions for founders, examined by councils of historical minds. Find the exact question you are facing and start your own agon.",
  openGraph: {
    title: "Decisions — Consult The Dead",
    description:
      "42 high-intent decisions for founders, examined by councils of historical minds.",
