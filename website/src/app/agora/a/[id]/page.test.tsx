...
describe("Agora public share page", () => {
  it("renders the full public share surface for a resolved agon", async () => {
    ...
    // CTA always carries share-loop UTM attribution — cold visitors with no
    // incoming UTMs still land on /agora with full attribution, per
    // GOAL_FOUNDER.md "every shared link is an acquisition unit".
