...
export const INSIGHT_ENTRIES: InsightEntry[] = [
  ...
  // ── Wave 23 collision articles ────────────────────────────────────────────
  {
    ...
    type: "collision",
    frameworkSlug: "andrew-carnegie",
    collisionFrameworkSlugs: ["andrew-carnegie", "sun-tzu"],
    title:
    ...
    targetKeywords: [
      "people strategy vs market positioning startup",
      "Andrew Carnegie Sun Tzu leadership strategy comparison",
      "build great team vs find right market startup",
      "talent first vs positioning first business strategy",
      "relationship capital vs competitive moat startup",
    ],
    decisionType: "people-vs-terrain",
    hookQuestion:
  ...
  },
  {
    ...
    targetKeywords: [
      "how to reform a broken company culture startup",
      "new leader inherits dysfunction what to do",
      "Catherine the Great Machiavelli reform leadership",
      "turnaround leadership inherited company startup",
      "reform from within vs disrupt and replace organization",
    ],
    decisionType: "reform",
    hookQuestion:
  ...
  },
  {
    ...
    targetKeywords: [
      "Edison Tesla inventor strategy comparison startup",
      "build platform vs achieve technical breakthrough startup",
      "patent strategy vs open innovation founder",
      "system building vs discovery research startup",
      "moat vs innovation startup strategy",
    ],
  ...
  // ── Wave 25: collision articles ───────────────────────────────────────
  {
    slug: "napoleon-vs-caesar-on-speed-of-conquest-vs-consolidation",
    type: "collision",
    frameworkSlug: "napoleon-bonaparte",
    collisionFrameworkSlugs: ["napoleon-bonaparte", "julius-caesar"],
    title:
  ...
  },
  {
    ...
    agonExcerpt: [
      {
        speaker: "Galileo Galilei",
        text: "The theory of perfect celestial spheres was coherent, mathematically elegant, and endorsed by the greatest minds of the preceding two thousand years. It was wrong. Not wrong in a small detail that a refinement could fix — wrong in its fundamental premise about the nature of the heavens. No amount of additional theoretical work on the Ptolemaic model would have revealed what the telescope showed me in the first week I pointed it at Jupiter. The moons were there. They were always there. The theory was not wrong because someone reasoned their way to its failure — it was wrong because the observation was incompatible with it, and the observation had simply never been made. A founder who theorizes about what users need without observing what users actually do is building a Ptolemaic model. It may be internally consistent. It will almost certainly be wrong in the dimension that matters most.",
      },
      {
        speaker: "Ada Lovelace",
        text: "Galileo's telescope produced the observation that falsified the theory. I am asking what theory was required to build the telescope in the first place. The instrument does not precede the conceptual framework — it embodies one. The question for a founder is not whether to theorize but whether the theoretical work has been done at the right level of abstraction. Babbage had the mechanism. What was missing was the conceptual framework that distinguished between a machine that performs a specific calculation and a machine that performs any calculation that can be expressed symbolically. That distinction — between special-purpose and general-purpose — is theoretical, not empirical. No amount of observation of working calculators would have produced it. It required someone to think carefully about what computation actually is before any general-purpose computer existed. The founders who skip that theoretical work build very good special-purpose tools and cannot understand why they keep hitting the ceiling.",
      },
    ],
    conclusion: {
      frameworkSlug: "galileo-galilei",
      summary:
        "Galileo and Lovelace converge on a sequencing principle that founders building in technically complex or behaviorally uncertain domains must apply honestly: theoretical clarity is most valuable when it defines the design space before experiments are run, and empirical observation is most valuable when theory has made predictions that the real world might falsify. Galileo is correct that inherited theories are often wrong in ways that only observation can reveal, and that the cost of theoretical confidence without empirical grounding is building an internally consistent model of a world that does not exist. Lovelace is correct that the wrong level of theoretical abstraction makes experiments answerable but unimportant — you can measure everything and learn nothing if the theoretical framework is not asking the questions that actually determine the outcome. The resolution is sequential: invest in theoretical clarity until you have identified the specific predictions that are falsifiable through observation, then invest in the observations that test those predictions.",
      actionableInsight:
        "Before deciding whether to move to empirical testing or invest more in theoretical clarity, run this diagnostic on your current model. First: does your theory make specific, falsifiable predictions about what you will observe — not 'users will find this valuable' but 'users will return to this feature at least twice in the first week, and users who do not will churn within thirty days'? If your theory does not yet make predictions specific enough to be falsified by data, more theoretical work is required before empirical testing will produce interpretable results. Second: is the phenomenon you need to observe actually available for observation without building the product? If user behavior in the specific context you care about can be studied through existing analogues, competitive products, or structured interviews before you build, Galileo's model applies — observe before theorizing further. If the phenomenon only becomes observable after the product exists, Lovelace's model applies — invest in theoretical clarity until you are confident you are building in the right design space, because your first empirical data will arrive expensive, and you need the theoretical framework to interpret it correctly.",
    },
  },
