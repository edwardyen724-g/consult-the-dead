...
- Step 1 — This week: Audit every portfolio company and rank them by proximity to a liquidity event; identify the single best candidate and schedule a board call to pressure-test exit pathways, secondary buyers, or partial liquidity options.
- Step 2 — Next 30-60 days: Execute relentlessly on the identified exit pathway while maintaining warm but non-committal contact with two to three anchor LP prospects — share a brief quarterly update letter with verified portfolio metrics, no fundraising ask, to preserve presence without premature commitment.
- Step 3 — Upon close of liquidity event: Open formal Fund II conversations with anchor LPs using the verified DPI as the opening fact, present the full portfolio as thesis validation in motion, and let the fundraise generate its own momentum from a foundation that cannot be rhetorically dismantled.
