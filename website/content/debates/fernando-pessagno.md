...
- Step 1 — This week: Build a simple spreadsheet tracking revenue per maintenance hour and month-over-month growth rate for every product in your portfolio. Include a third column: 'Would I rebuild this from scratch?' scored 1-3. This is your measurement instrument.
- Step 2 — End of week: Identify the one or two products with the highest revenue-per-attention-hour ratio AND a positive growth trajectory. Everything else receives a firm sunset date of 30 days — no exceptions for sentimental attachment or 'optionality.'
- Step 3 — Week two onward: Redirect 100% of your creative and maintenance attention to the surviving product(s). Treat the concentration not as increased vulnerability but as the restoration of a force capable of genuine dominance — this is the threshold your distributed architecture has been preventing you from reaching.
