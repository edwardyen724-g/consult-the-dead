...
- Step 1 (Today) — Write your falsification conditions in writing before opening any analytics: specify the exact conversion rates, CAC trends, churn cohort patterns, and acquisition channel decay that would force you to conclude the playbook is failing. Make them stringent enough that your prior-exit identity would resist signing them. Do not touch a dashboard until this document exists.
- Step 2 (This week) — Instrument every stage of your growth funnel with cohort-level quantitative precision you have not previously applied: acquisition cost by channel and cohort vintage, conversion rate by acquisition source, churn rate by cohort age, and payback period trends across the last six months. Measure only the variables your falsification conditions named so your identity cannot retroactively select flattering metrics.
- Step 3 (Week two) — Audit the market's structural configuration against what the data surfaces: identify which actors now control acquisition authority in your market, whether your early-adopter coalition has been commoditized by imitators, and whether the information asymmetry your original tactic exploited still exists. Use this audit to explain anomalies the funnel data revealed — not to confirm prior assumptions.
