...
- Step 1 (this week) — Write a one-paragraph private declaration that you are no longer a portfolio operator; you are building one product with permanence. Post it somewhere you see daily. Stop entertaining any new small-bet ideas for 90 days — treat every new idea as captured correspondence and discard it unread.
- Step 2 (next 21 days) — Instrument every tool with four identical metrics: 90-day retention rate, monthly expansion revenue per user, support tickets per $1K MRR, and net revenue churn. Use a single shared dashboard so comparison is direct. Do not make the consolidation decision until this data exists.
- Step 3 (day 22–90) — Identify the single tool with the best combined score on retention and expansion relative to support burden — this is your pitchblende. Announce sunset timelines or sell/hand-off processes for all other tools, and spend the recovered time exclusively on competitive moat-building: deeper integrations, switching cost engineering, and user community infrastructure for the chosen product.
