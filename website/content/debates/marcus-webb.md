...
- Step 1 — This week: Stop accepting new pitch meetings. Write a one-page statement of what you are NOT funding this fund, with explicit founder archetypes, market configurations, and deal structures that automatically disqualify. Make this a binding document, not a heuristic.
- Step 2 — Weeks 2-4: Build a founder-signal taxonomy from your existing portfolio by forcing yourself to articulate the three to five observable signals that predicted your best outcomes and your worst. This is your pattern library — it must be empirical, drawn from your own data, not borrowed frameworks.
- Step 3 — Weeks 5-6: Draft a market-configuration thesis that maps which problem spaces you are pre-committed to funding before any specific company enters your pipeline. Return to full deal volume only after all three artifacts are written, stress-tested against three real deals from memory, and shared with one external advisor for adversarial review.
