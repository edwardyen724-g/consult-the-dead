...
- Step 1 — This week: Pull every customer record and manually classify each acquisition path as 'agency-referred,' 'agency-adjacent' (e.g., referral from an agency client), or 'fully independent.' This is Curie's electrometer measurement and costs only time.
- Step 2 — Next two weeks: Formally restructure the agency as a paying client of the product at standard market rates, creating a visible internal P&L split. Watch whether the agency resists the pricing — resistance is Machiavelli's diagnostic pressure revealing whether the two entities can actually be separated.
- Step 3 — At 60 days: Evaluate the combined output — if 40%+ of customers are agency-independent AND the agency is paying market rates without existential resistance, initiate full decoupling with a defined 90-day wind-down of shared operations. If the audit reveals deeper dependency, extend the structured subordination period and invest directly in one independent acquisition channel before revisiting.
