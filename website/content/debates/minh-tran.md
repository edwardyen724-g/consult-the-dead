...
- Step 1 — This week: Pull the expansion revenue ratio from your billing system for both products. Calculate the percentage of existing customers who have upgraded, expanded seats, or increased usage without being solicited. This number already exists and requires no new measurement period.
- Step 2 — Within 14 days: Identify which product wins on expansion revenue ratio, then corroborate it with two secondary signals — net revenue retention above 100% and unsolicited customer referrals. If both secondary signals confirm the same product, your decision is made. If they conflict, weight expansion revenue ratio as the tiebreaker.
- Step 3 — Within 30 days: Execute a hard, structural dissolution of the weaker product — wind it down, sell it, or transfer it — not a soft deprioritization. Simultaneously announce internally and to customers that all resources now flow to the winning product. Treat the dissolution date as a pre-commitment device, not a target you can slip.
