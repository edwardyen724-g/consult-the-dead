...
- Step 1 (This week) — Hire or promote a fund operator and have legal draft a written information barrier policy that explicitly prohibits VCSheet deal-flow data from entering live fund investment evaluation; send this document to LPs as a proactive disclosure.
- Step 2 (Next 30 days) — Redesign your personal calendar so VCSheet gets your highest-energy morning blocks five days a week for product, distribution, and partnership decisions; schedule fund investment calls as fixed, bounded slots where you bring full judgment but not daily administration.
- Step 3 (Next 90 days) — Establish a quarterly audit of the information barrier with your fund counsel to confirm it is functioning as a continuous discipline rather than a forgotten founding document, and set explicit distribution milestones for VCSheet that trigger a reassessment of the attention split.
