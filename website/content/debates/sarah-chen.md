...
- Step 1 — This week: Write a one-page honest audit of your specific knowledge edges — industries, networks, founder archetypes, and technical domains where you have information asymmetry that a generalist fund cannot replicate. Rank every current or prospective portfolio company against that list and eliminate any that do not sit squarely inside your top two knowledge domains.
- Step 2 — Within 30 days: For the two companies that survive that audit, conduct exhaustive diligence beyond what is standard — map every key hire, every customer relationship, every competitive threat, and every second-order assumption in the business model until you encounter at least one genuine anomaly or model-revision that changes your view. If no anomaly surfaces, your diligence is not deep enough. Negotiate board seat terms and target 10–15% ownership before closing.
- Step 3 — Within 90 days: Execute one high-visibility, independently verifiable intervention in each company — a named hire you recruited, a customer introduction that closed, or a strategic decision you initiated and can document in board minutes — and brief your LPs on these specific actions with named founders who will corroborate them unprompted.
