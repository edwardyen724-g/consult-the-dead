...
- Step 1 — This week: Identify your 5-10 most active open-source contributors and privately brief them that you are designing a governance structure for sustainable funding before any commercial pricing changes; ask for their participation in shaping it, not their approval of a fait accompli.
- Step 2 — Weeks 2–8: Publicly draft and iterate the foundation charter, funding formula (e.g., 20% of enterprise MRR flows to the foundation treasury), and contributor audit rights in the open, with a visible changelog so the community watches the mechanism being built in real time.
- Step 3 — Weeks 9–12: Incorporate the foundation as a legal entity, transfer the first tranche of funding publicly, launch the enterprise tier with a direct link to the foundation's live treasury dashboard, and publish the irrevocable covenant Marcus demands as the foundation's founding document — so the institution and the document reinforce each other rather than compete.
