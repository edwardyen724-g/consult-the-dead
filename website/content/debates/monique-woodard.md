...
- Step 1 — This week: Decompose each demographic position into 3-5 quantifiable sub-thesis milestones with 18-36 month confirmation windows; build a one-page dashboard template that replaces NAV-only LP reporting starting at your next quarterly meeting.
- Step 2 — Within 30 days: Audit your current LP base against a single criterion — have they demonstrated the ability to hold a 10+ year horizon position in any prior fund or asset class? Categorize each LP as aligned, uncertain, or structurally incompetent, then begin quietly managing the incompetent tier toward passive status or secondary exit before the next major inflection point in the thesis.
- Step 3 — Before any Fund II outreach: Draft one paragraph of explicit fund agreement language committing that thesis positions will not be modified in response to interim NAV pressure, share it with your legal counsel, and open every Fund II LP conversation with that language before discussing terms, strategy, or check size — treating any LP who hesitates on it as disqualified regardless of capital availability.
