...
- Step 1 — This week, audit your calendar and block 6:00–9:00 AM (or equivalent first-hours) every working day as 'writing — non-negotiable fiduciary time,' and communicate to all portfolio companies that you are unavailable before 9:00 AM with no exceptions.
- Step 2 — This week, list your current portfolio companies and score each one: does its core problem appear as a recurring subject in your published essays? Deprioritize board engagement for any company scoring low, and consider whether those seats should be converted to observer or advisory roles to recover your time.
- Step 3 — Before accepting any new deal, run it through a written one-paragraph test: 'How does this company generate an essay I could not write without having been inside it?' If you cannot answer that in 60 seconds, pass on the board seat — take the check without the active engagement, or skip entirely.
