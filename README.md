...
| `/minds/[id]` | Public, static-generated, SEO | 30 per-mind landing pages (one per active framework); each includes how-they-argue, sample quotes, and UTM-linked /agora CTA |
...
| `/decisions` | Public, static-generated | Index of all 87 published decision pages (e.g. "Should I raise VC or bootstrap?"); each card links to its decision detail page |
