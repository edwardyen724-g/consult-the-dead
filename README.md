...
| `/minds/[id]` | Public, static-generated, SEO | 29 per-mind landing pages (one per active framework); each includes how-they-argue, sample quotes, and UTM-linked /agora CTA |
