  ...
  return (
    <section className={`flex flex-col p-5 ${className}`}>
      <div
        ...
        style={{ color: 'rgba(255,255,255,0.25)', fontFamily: 'var(--font-jetbrains-mono), monospace' }}
      >
        {title}
      </div>
...
function CanvasLoader() {
  return (
    <div className="relative flex h-full min-h-[420px] items-center justify-center overflow-hidden rounded-2xl border border-white/5 bg-[#0a0a0f]">
      <div
      ...
      <div className="relative text-center">
        <div
          ...
          style={{ color: 'rgba(255,255,255,0.24)', fontFamily: 'var(--font-jetbrains-mono), monospace' }}
        >
          Initializing command center
        </div>
        <div
          className="text-[13px] italic"
          style={{ color: 'rgba(255,255,255,0.56)', fontFamily: 'var(--font-newsreader), serif' }}
        >
